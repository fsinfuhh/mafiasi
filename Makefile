...
css: ${base_static}css/main.min.css ${base_static}css/bootstrap.min.css ${base_static}css/smoothness/jquery-ui-1.12.1.custom.min.css ${pks_static}css/pks.min.css ${mumble_static}css/mumble.min.css
