...
def create_list(request, group_name):
    ...
    if request.method == "POST":
        ...
        if created:
            msg = _("Mailinglist {list_name} was created.").format(list_name=group.name)
...
def manage_whitelist(request, group_name):
    ...
    return render(
        request,
        "mailinglist/whitelist.html",
        {"mailinglist": mailinglist, "entries": entries, "add_form": add_form, "is_admin": is_admin},
    )
...
def manage_settings(request, group_name):
    ...
    return render(request, "mailinglist/settings.html", {"mailinglist": mailinglist, "form": form})
