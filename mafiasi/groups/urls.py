...
urlpatterns = [
    ...
    path('g/<slug:group_name>/action/<int:member_pk>', group_action,
            name='groups_action'),
    path('invitations/<int:invitation_pk>/action', invitation_action,
            name='groups_invitation_action'),
    path('invitations/<int:invitation_pk>/withdraw', withdraw_invite,
