...
urlpatterns = [
    ...
    path("notifications/delete/<int:notification_pk>", delete_notification, name="gprot_notification_delete"),
    path("reminders/", reminders, name="gprot_reminders"),
    path("reminders/delete/<int:reminder_pk>", delete_reminder, name="gprot_reminder_delete"),
