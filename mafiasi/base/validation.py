...
class AsciiValidator(object):
    ...
    def validate(self, password, user=None):
        try:
            ...
            raise ValidationError(_("Your password contains invalid characters. Only ASCII characters are allowed."))

    def get_help_text(self):
        return (
            _("Your password may only contain the following characters: %s")
